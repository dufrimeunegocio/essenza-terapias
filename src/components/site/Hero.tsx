        ...
        <div className="reveal order-2 lg:order-1">
          ...
          <div className="mt-9 flex flex-col items-start">
            <a
              ...
              className="rounded-full bg-gold px-8 py-4 text-center text-xs tracking-[0.18em] uppercase text-button-foreground shadow-[var(--shadow-soft)] transition-all duration-500 hover:-translate-y-0.5 hover:bg-ink-foreground hover:text-button-foreground"
            >
              Agendar atendimento
            </a>
          </div>
